...
<model ref="r:6750926d-42b6-41a5-9a0a-d33714e840b2(ChiselLanguage.behavior)">
  ...
  <node concept="13h7C7" id="3kclFPuRaYh">
    <property role="3GE5qa" value="Input" />
    <ref role="13h7C2" to="qmf0:7Vd20ShbnlU" resolve="InputRef" />
    <node concept="13hLZK" id="3kclFPuRaYi" role="13h7CW">
      <node concept="3clFbS" id="3kclFPuRaYj" role="2VODD2" />
    </node>
  </node>
</model>
